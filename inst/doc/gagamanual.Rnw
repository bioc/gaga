...
gg5 <- fitGG(x[,c(-6,-12)],groups,patterns=patterns,method='quickEM',trace=FALSE)  
@ 
...
gg5 <- parest(gg5,x=x[,c(-6,-12)],groups,alpha=.05)
gg1
gg1$ci
gg2
gg2$ci
...
For example, the first gene has a posterior probability of 0.994768
of following pattern 0 ({\it i.e.} being equally expressed)
and a probability of 0.0052 of following pattern 1 
({\it i.e.} being differentially expressed) under the fully
Bayesian fit, and 0.0051 under the maximum likelihood fit.
...
d5 <- findgenes(gg5,x[,c(-6,-12)],groups,fdrmax=.05,parametric=TRUE)
table(d1$d,d2$d)
table(d1$d,d3$d)
table(d1$d,d4$d)
table(d1$d,d5$d)
